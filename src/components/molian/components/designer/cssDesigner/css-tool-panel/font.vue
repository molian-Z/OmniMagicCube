        ...
        <div class="css-panel__row">
          <div class="css-panel__input-wrapper" style="width: 100%">
            <customSelect
              ...
              @update:modelValue="css.fontFamily = $event"
        ...
        <div class="css-panel__row css-panel__row--between">
          <div class="css-panel__input-wrapper">
            <customSelect
              ...
              @update:modelValue="css.fontWeight = $event"
              :disabled="!selectedComp"
              :filterable="true"
          ...
          <div class="css-panel__input-wrapper">
            <customSelect
              ...
              @update:modelValue="css.fontSize = $event"
              :disabled="!selectedComp"
              :filterable="true"
        ...
        <div class="css-panel__row css-panel__row--between">
          <div class="css-panel__input-wrapper">
            <customInput
              ...
              @update:modelValue="css.lineHeight = $event"
              :disabled="!selectedComp"
              placeholder="Auto"
            >
              <template #prefixIcon>
          ...
          <div class="css-panel__input-wrapper">
            <customInput
              ...
              @update:modelValue="css.letterSpacing = $event"
              :disabled="!selectedComp"
              placeholder="0"
            >
              <template #prefixIcon>
        ...
        <div class="css-panel__row css-panel__row--between">
          <div class="css-panel__input-wrapper">
            <customInput
              ...
              @update:modelValue="css.paragraphSpacing = $event"
              :disabled="!selectedComp"
              placeholder="Auto"
            >
              <template #prefixIcon>
